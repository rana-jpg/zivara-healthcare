function Home() {
  return (
    <section
      id="home"
      className="px-4 md:px-10 py-16 md:py-32"
    >
      <div className="max-w-6xl mx-auto bg-white/20 backdrop-blur-md rounded-2xl md:rounded-[40px] p-6 md:p-16 border border-white/30 shadow-2xl text-center">
